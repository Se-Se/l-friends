...
export default {
  ...
  methods: {
    ...
    payments: function (pgType, payType) {
      ...
      let receiverContact1Input = this.$refs.orderDeliveryAddressInfo.receiverContact1Input
      ...
      let lengthCheckd = receiverContact1Input.phone1 + receiverContact1Input.phone2 + receiverContact1Input.phone3
      if (receiverContact1Input.phone1 === '' || receiverContact1Input.phone2 === '' || receiverContact1Input.phone3 === '' || receiverContact1Input.phone1.substring(0, 1) !== '0' || lengthCheckd.length < 10) {
        Alert({
      ...
      this.orderData.orderer = {
        ordererName: this.ordersheet.ordererContact.ordererName,
      ...
      this.orderData.orderTitle =
        ...
        (this.orderProductOptions.length > 1
          ? ' 外 ' + (this.orderProductOptions.length - 1) + ''
          : '')
      ...
      confirmUrl = `${location.protocol}//${location.host}/m/order/paymentconfirm`
      ...
      this.orderData.shippingAddress.addressName = 'address'
      ...
      this.$store
        ...
        .then(res => {
          ...
          if (res.data.returnContents) {
            ...
            OpenWindow.document.write(res.data.returnContents)
            // var OpenWindow = window.open('/order.html',"_blank",'height=800,width=850');
