<template>
  <div class="good_area pt-28">
    <p class="ico_new">
      <span class="badge badge_purple badge_titletop">BEST</span>
    </p>
    ...
    <ul class="good_list column-2">
      <template v-if="products && products.brandBestProductInfos">
        <li v-for="product in showProducts" :key="product.productNo">
          <router-link :to="`/m/product/detail/${product.productNo}`">
            <div class="photo_wrap">
              <span class="icon new">BEST</span>
              <div class="thumbnail">
