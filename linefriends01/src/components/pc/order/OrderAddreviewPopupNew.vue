<template>
  <modal-layer-popup :width="680" :visible.sync="active" :popup_size_class="'roller_area popup_size_5'" popup_name="orderAddreviewPopupName" @closeOrderAddReviewPopup="closeOrderAddReviewPopup">
    ...
    <div class="con">
      ...
      <div class="txt_ex_2">
        <ul class="list_det">
          <li>상품평 작성을 완료하시면 구매확정으로 처리됩니다.</li>
        </ul>
      </div>
      <div class="btn_list">
